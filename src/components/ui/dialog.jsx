...
const DialogOverlay = forwardRef(({ className, ...props }, ref) => (
	<DialogPrimitive.Overlay
		ref={ref}
		className={cn(
			"data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 bg-black/80 p-5",
			className
		)}
		{...props}
	/>
...
const DialogHeader = ({ className, ...props }) => (
	<div className={cn("xs:text-left flex flex-col space-y-1.5 text-center", className)} {...props} />
);
DialogHeader.displayName = "DialogHeader";

const DialogFooter = ({ className, ...props }) => (
	<div className={cn("xs:flex-row xs:justify-end xs:space-x-2 flex flex-col-reverse", className)} {...props} />
);
DialogFooter.displayName = "DialogFooter";
