...
const NavigationMenu = ({
	...
	<NavigationMenuPrimitive.Root ref={ref} className={cn("relative z-10 flex items-center justify-center", className)} {...props}>
		{children}
...
}) => <NavigationMenuPrimitive.List ref={ref} className={cn("group flex flex-1 list-none items-center justify-center gap-3", className)} {...props} />;
